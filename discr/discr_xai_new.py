# -*- coding: utf-8 -*-
"""
This machine learning program works on a dataset forged with a discrimination parameter, such the breed and the number of crimes committed in the past of the subject.
If the subject is Martian has more probabilities to be classified as 'suspect'than a Terrestrial.
The dataset is influenced by the attributes of breed
...
#print (new_y)
exp.save_to_file('lime_terrestrial.html')
...
print(np.asarray(valori))
print("Accuracy Train:",round(acctrain*100,2),"% Accuracy Test: ",round(acctest*100,2),"%")
print (colored('CHECK WITH NO BREED','white','on_green'))
print("Predicted target name: {}".format(prediction)," \n",names," \n"," ",valori,"   ",prediction)
#new_y = pd.get_dummies(df['suspect'], drop_first=True)
#print (new_y)
